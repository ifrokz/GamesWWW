cBuild = function(posX, posY){
    this.fila = posY/40;
    this.columna = posX/40;
    console.log("C:"+this.columna+"F:"+this.fila);
    ...
    this.draw = function(){
        ...
        ctx.drawImage(barrack,this.isoX-cursor1.width/2+gapX,this.isoY-cursor1.height+gridSize/4+gapY,cursor1.width,cursor1.width);
    }
}